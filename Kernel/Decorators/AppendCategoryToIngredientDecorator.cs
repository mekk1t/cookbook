...
{
    public class AppendCategoryToIngredientDecorator : ICommand<AppendExistingCategoryToIngredientCommand>
    {
        ...
        private readonly ICommand<AppendExistingCategoryToIngredientCommand> _decoratee;
        ...
        public AppendCategoryToIngredientDecorator(
            ...
            ICommand<AppendExistingCategoryToIngredientCommand> decoratee)
        {
